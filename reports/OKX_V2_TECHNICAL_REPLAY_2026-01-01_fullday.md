# OKX technical strategy replay — BTC-USDT-SWAP 2026-01-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-01-01/`
**Run wall-clock:** 1429.5 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 18 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 18 |
| Triggered                         | 11 |
...
| Duplicate suppressions (dedup)    | 18121 |
...
See `OKX_TECHNICAL_REPLAY_2026-01-01_ZONES.csv` for the per-zone breakdown.
