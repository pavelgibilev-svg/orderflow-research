# OKX technical strategy replay — BTC-USDT-SWAP 2024-07-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2024-07-01/`
**Run wall-clock:** 3551.1 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 17 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 17 |
| Triggered                         | 9 |
...
| Duplicate suppressions (dedup)    | 15104 |
...
See `OKX_TECHNICAL_REPLAY_2024-07-01_ZONES.csv` for the per-zone breakdown.
