# OKX technical strategy replay — BTC-USDT-SWAP 2025-09-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-09-01/`
**Run wall-clock:** 7449.7 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 31 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 31 |
| Triggered                         | 23 |
...
| Duplicate suppressions (dedup)    | 15048 |
...
See `OKX_TECHNICAL_REPLAY_2025-09-01_ZONES.csv` for the per-zone breakdown.
