# OKX technical strategy replay — BTC-USDT-SWAP 2025-04-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-04-01/`
**Run wall-clock:** 5833.5 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 41 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 41 |
| Triggered                         | 26 |
| RESOLVED_REACHED (raw)            | 10 |
| RESOLVED_FAILED                   | 16 |
| EXPIRED                           | 0 |
| INVALIDATED                       | 12 |
| NO_TRIGGER                        | 3 |
...
| Duplicate-move credits absorbed   | 8 |
| Duplicate suppressions (dedup)    | 11992 |
...
See `OKX_TECHNICAL_REPLAY_2025-04-01_ZONES.csv` for the per-zone breakdown.
