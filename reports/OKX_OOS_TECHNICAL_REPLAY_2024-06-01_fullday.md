# OKX technical strategy replay — BTC-USDT-SWAP 2024-06-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2024-06-01/`
**Run wall-clock:** 1600.4 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 9 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 9 |
| Triggered                         | 8 |
...
| Duplicate suppressions (dedup)    | 18361 |
...
See `OKX_TECHNICAL_REPLAY_2024-06-01_ZONES.csv` for the per-zone breakdown.
