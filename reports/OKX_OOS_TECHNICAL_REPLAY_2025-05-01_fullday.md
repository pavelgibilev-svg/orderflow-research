# OKX technical strategy replay — BTC-USDT-SWAP 2025-05-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-05-01/`
**Run wall-clock:** 4136.6 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 44 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 44 |
| Triggered                         | 28 |
...
| Duplicate suppressions (dedup)    | 16053 |
...
See `OKX_TECHNICAL_REPLAY_2025-05-01_ZONES.csv` for the per-zone breakdown.
