# OKX technical strategy replay — BTC-USDT-SWAP 2025-11-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-11-01/`
**Run wall-clock:** 1731.3 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 13 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 13 |
| Triggered                         | 9 |
...
| Duplicate suppressions (dedup)    | 16077 |
...
See `OKX_TECHNICAL_REPLAY_2025-11-01_ZONES.csv` for the per-zone breakdown.
