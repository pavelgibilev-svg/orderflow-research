# OKX technical strategy replay — BTC-USDT-SWAP 2026-04-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-04-01/`
**Run wall-clock:** 3514.5 s
...
| Duplicate suppressions (dedup)    | 12987 |
...
See `OKX_TECHNICAL_REPLAY_2026-04-01_ZONES.csv` for the per-zone breakdown.
