# OKX technical strategy replay — BTC-USDT-SWAP 2024-10-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2024-10-01/`
**Run wall-clock:** 5202.5 s
...
| Duplicate suppressions (dedup)    | 10744 |
...
See `OKX_TECHNICAL_REPLAY_2024-10-01_ZONES.csv` for the per-zone breakdown.
