# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-21

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-21/`
**Run wall-clock:** 1761.1 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 21 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 21 |
| Triggered                         | 15 |
...
| Duplicate-move credits absorbed   | 9 |
| Duplicate suppressions (dedup)    | 19368 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-21_ZONES.csv` for the per-zone breakdown.
