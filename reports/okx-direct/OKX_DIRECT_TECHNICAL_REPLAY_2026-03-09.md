# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-09

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-09/`
**Run wall-clock:** 7470.4 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 48 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 48 |
| Triggered                         | 30 |
| RESOLVED_REACHED (raw)            | 9 |
| RESOLVED_FAILED                   | 21 |
| EXPIRED                           | 1 |
| INVALIDATED                       | 15 |
| NO_TRIGGER                        | 2 |
...
| Duplicate suppressions (dedup)    | 9263 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-09_ZONES.csv` for the per-zone breakdown.
