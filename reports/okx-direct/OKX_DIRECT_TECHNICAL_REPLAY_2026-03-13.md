# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-13

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-13/`
**Run wall-clock:** 5095.5 s
...
| Duplicate suppressions (dedup)    | 10886 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-13_ZONES.csv` for the per-zone breakdown.
