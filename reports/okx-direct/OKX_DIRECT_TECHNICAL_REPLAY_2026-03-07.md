# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-07

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-07/`
**Run wall-clock:** 12430.6 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 27 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 27 |
| Triggered                         | 18 |
...
| Duplicate suppressions (dedup)    | 16068 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-07_ZONES.csv` for the per-zone breakdown.
