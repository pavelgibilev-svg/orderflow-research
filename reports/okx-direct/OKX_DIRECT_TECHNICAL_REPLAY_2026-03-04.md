# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-04

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-04/`
**Run wall-clock:** 7983.3 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 54 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 54 |
| Triggered                         | 32 |
| RESOLVED_REACHED (raw)            | 15 |
| RESOLVED_FAILED                   | 17 |
| EXPIRED                           | 1 |
| INVALIDATED                       | 18 |
| NO_TRIGGER                        | 3 |
...
| Duplicate-move credits absorbed   | 14 |
| Duplicate suppressions (dedup)    | 8931 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-04_ZONES.csv` for the per-zone breakdown.
