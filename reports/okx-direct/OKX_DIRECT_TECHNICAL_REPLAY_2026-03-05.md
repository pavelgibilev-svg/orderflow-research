# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-05

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-05/`
**Run wall-clock:** 7051.1 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 29 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 29 |
| Triggered                         | 13 |
...
| Duplicate-move credits absorbed   | 4 |
| Duplicate suppressions (dedup)    | 10367 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-05_ZONES.csv` for the per-zone breakdown.
