# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-11

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-11/`
**Run wall-clock:** 4690.0 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 30 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 30 |
| Triggered                         | 21 |
...
| Duplicate suppressions (dedup)    | 11467 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-11_ZONES.csv` for the per-zone breakdown.
