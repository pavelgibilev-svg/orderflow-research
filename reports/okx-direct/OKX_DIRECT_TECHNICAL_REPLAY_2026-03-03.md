# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-03

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-03/`
**Run wall-clock:** 7935.2 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 46 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 46 |
| Triggered                         | 26 |
| RESOLVED_REACHED (raw)            | 12 |
| RESOLVED_FAILED                   | 14 |
| EXPIRED                           | 1 |
| INVALIDATED                       | 18 |
| NO_TRIGGER                        | 1 |
| LONG zones                        | 23 |
| SHORT zones                       | 23 |
| Unique-move clusters              | 2 |
| Duplicate-move credits absorbed   | 10 |
| Duplicate suppressions (dedup)    | 10192 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-03_ZONES.csv` for the per-zone breakdown.
