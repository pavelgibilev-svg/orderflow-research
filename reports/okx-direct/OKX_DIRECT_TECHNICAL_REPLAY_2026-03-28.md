# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-28

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-28/`
**Run wall-clock:** 1858.7 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 23 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 23 |
| Triggered                         | 15 |
...
| Duplicate suppressions (dedup)    | 14387 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-28_ZONES.csv` for the per-zone breakdown.
