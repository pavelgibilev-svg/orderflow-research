# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-18

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-18/`
**Run wall-clock:** 4474.5 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 57 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 57 |
| Triggered                         | 33 |
...
| Duplicate suppressions (dedup)    | 12056 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-18_ZONES.csv` for the per-zone breakdown.
