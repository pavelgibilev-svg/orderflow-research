# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-16

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-16/`
**Run wall-clock:** 4767.4 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 45 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 45 |
| Triggered                         | 24 |
| RESOLVED_REACHED (raw)            | 3 |
| RESOLVED_FAILED                   | 21 |
| EXPIRED                           | 1 |
| INVALIDATED                       | 15 |
| NO_TRIGGER                        | 5 |
...
| Duplicate-move credits absorbed   | 2 |
| Duplicate suppressions (dedup)    | 11140 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-16_ZONES.csv` for the per-zone breakdown.
