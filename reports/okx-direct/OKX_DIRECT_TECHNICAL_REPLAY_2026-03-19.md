# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-19

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-19/`
**Run wall-clock:** 5912.7 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 51 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 51 |
| Triggered                         | 27 |
...
| Duplicate suppressions (dedup)    | 11913 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-19_ZONES.csv` for the per-zone breakdown.
