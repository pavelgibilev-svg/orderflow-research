# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-08

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-08/`
**Run wall-clock:** 3708.0 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 34 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 34 |
| Triggered                         | 21 |
| RESOLVED_REACHED (raw)            | 8 |
| RESOLVED_FAILED                   | 13 |
| EXPIRED                           | 0 |
| INVALIDATED                       | 8 |
| NO_TRIGGER                        | 5 |
...
| Duplicate-move credits absorbed   | 7 |
| Duplicate suppressions (dedup)    | 13680 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-08_ZONES.csv` for the per-zone breakdown.
