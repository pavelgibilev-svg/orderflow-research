# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-25

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-25/`
**Run wall-clock:** 3579.2 s
...
| Duplicate suppressions (dedup)    | 11008 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-25_ZONES.csv` for the per-zone breakdown.
