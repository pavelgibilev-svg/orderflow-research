# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-30

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-30/`
**Run wall-clock:** 4019.3 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 38 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 38 |
| Triggered                         | 23 |
| RESOLVED_REACHED (raw)            | 5 |
| RESOLVED_FAILED                   | 18 |
| EXPIRED                           | 0 |
| INVALIDATED                       | 12 |
| NO_TRIGGER                        | 3 |
...
| Duplicate suppressions (dedup)    | 14990 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-30_ZONES.csv` for the per-zone breakdown.
