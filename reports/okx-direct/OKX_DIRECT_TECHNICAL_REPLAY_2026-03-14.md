# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-14

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-14/`
**Run wall-clock:** 1418.4 s
...
| Duplicate suppressions (dedup)    | 17150 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-14_ZONES.csv` for the per-zone breakdown.
