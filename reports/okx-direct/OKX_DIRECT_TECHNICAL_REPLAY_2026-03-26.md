# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-26

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-26/`
**Run wall-clock:** 3830.0 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 49 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 49 |
| Triggered                         | 28 |
| RESOLVED_REACHED (raw)            | 11 |
| RESOLVED_FAILED                   | 17 |
| EXPIRED                           | 0 |
| INVALIDATED                       | 16 |
| NO_TRIGGER                        | 5 |
...
| Duplicate suppressions (dedup)    | 14511 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-26_ZONES.csv` for the per-zone breakdown.
