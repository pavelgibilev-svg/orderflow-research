# OKX technical strategy replay — BTC-USDT-SWAP 2026-03-24

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-03-24/`
**Run wall-clock:** 4701.2 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 36 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 36 |
| Triggered                         | 20 |
...
| Duplicate suppressions (dedup)    | 13397 |
...
See `OKX_TECHNICAL_REPLAY_2026-03-24_ZONES.csv` for the per-zone breakdown.
