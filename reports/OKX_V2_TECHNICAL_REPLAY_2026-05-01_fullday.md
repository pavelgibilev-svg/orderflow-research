# OKX technical strategy replay — BTC-USDT-SWAP 2026-05-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2026-05-01/`
**Run wall-clock:** 2465.5 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 28 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 28 |
| Triggered                         | 15 |
...
| Duplicate suppressions (dedup)    | 13470 |
...
See `OKX_TECHNICAL_REPLAY_2026-05-01_ZONES.csv` for the per-zone breakdown.
