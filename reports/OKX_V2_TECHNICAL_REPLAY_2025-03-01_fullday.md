# OKX technical strategy replay — BTC-USDT-SWAP 2025-03-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-03-01/`
**Run wall-clock:** 6368.4 s
...
| Duplicate-move credits absorbed   | 1 |
| Duplicate suppressions (dedup)    | 12739 |
...
See `OKX_TECHNICAL_REPLAY_2025-03-01_ZONES.csv` for the per-zone breakdown.
