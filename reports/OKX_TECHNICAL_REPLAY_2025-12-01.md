# OKX technical strategy replay — BTC-USDT-SWAP 2025-12-01

**Venue:** OKX (okex-swap)
**Window:** 3h window
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-12-01/`
**Run wall-clock:** 1727.3 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 11 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 11 |
| Triggered                         | 4 |
| RESOLVED_REACHED (raw)            | 4 |
| RESOLVED_FAILED                   | 0 |
| EXPIRED                           | 2 |
| INVALIDATED                       | 4 |
| NO_TRIGGER                        | 1 |
...
| Duplicate-move credits absorbed   | 3 |
| Duplicate suppressions (dedup)    | 1012 |
| Cooldown after resolve            | 30 min |
| Raw triggered hit-rate            | 100.00 % |
| Unique-move-adjusted hit-rate     | 25.00 % |
...
See `OKX_TECHNICAL_REPLAY_2025-12-01_ZONES.csv` for the per-zone breakdown.
