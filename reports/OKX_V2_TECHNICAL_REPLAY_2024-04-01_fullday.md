# OKX technical strategy replay — BTC-USDT-SWAP 2024-04-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2024-04-01/`
**Run wall-clock:** 6212.1 s
...
| Duplicate-move credits absorbed   | 13 |
| Duplicate suppressions (dedup)    | 13178 |
...
See `OKX_TECHNICAL_REPLAY_2024-04-01_ZONES.csv` for the per-zone breakdown.
