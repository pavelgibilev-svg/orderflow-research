# OKX technical strategy replay — BTC-USDT-SWAP 2025-08-01

**Venue:** OKX (okex-swap)
**Window:** full UTC day
**Target:** 2% on horizons 4h, 8h, 24h
**Underlying backtest report:** `reports/BTC-USDT-SWAP_2025-08-01/`
**Run wall-clock:** 7355.0 s
...
| metric                            | value |
|-----------------------------------|------:|
| Total zones created               | 35 |
| Still in CANDIDATE                | 0 |
| Confirmed (any later state)       | 35 |
| Triggered                         | 19 |
...
| Duplicate suppressions (dedup)    | 10991 |
...
See `OKX_TECHNICAL_REPLAY_2025-08-01_ZONES.csv` for the per-zone breakdown.
